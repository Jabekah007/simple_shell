 ...
 *
 * Return: 0 for success, 1 for failure, or an error code
 */
 ...
 * @info: this is the parameter & return info struct
 *
 * Return: -1 if builtin wasn't discovered,
 *			0 if builtin was perfomed successfully,
...
/**
 * find_cmd - it locates a command in PATH
 * @info: this is the parameter & return info struct
 *
 * Return: void
 */
 ...
 * @info: thi is the parameter & return info struct
 *
 * Return: void
 */
